...
| **E14b** | pure intent: no explicit wiring equalities; guards + behaviors only | §3.2 written without any net/`==` topology; §3.3 materialized — **slices 1–3 landed 2026-09-23** (min pull-up forcing, max low-hold forcing, bus assembly); remaining: en drive solving, rail inference, value-aware resistor matching, `derive on:` |
