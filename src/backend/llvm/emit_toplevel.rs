...
impl LlvmBackend {
    ...
    pub(super) fn emit_declares(&self, out: &mut String) {
        ...
        // 2026-09-11 (buffered stdout): NO declare — __stdout_flush is a
        // Briev defn emitted in full in this module when present; a textual
        // declare duplicates it and LLVM rejects the redefinition. Bare
        // programs never call it (has_stdout_flush gate).
                    ...
                    let ftd = crate::ast::top::TypeDef {
                        ...
                        body: crate::ast::top::TypeDefBody {
                            slots: slots.iter()
                                ...
                                .collect(),
                            metadata: Default::default(), pins: Vec::new(), reference: None, tolerance: None, projections: vec![],
